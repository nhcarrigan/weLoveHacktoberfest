...
export const tags: Tag[] = [
  ...
  },
  {
    name: "repos",
    content:
      "You can create pull requests to any open source project on GitHub and GitLab, provided that they are participating in Hacktoberfest. Look for the 'hacktoberfest' topic on the project to know that they're involved. PRs to repos that aren't participating won't be counted by Hacktoberfest.\n\n[View repositories on GitHub](https://github.com/topics/hacktoberfest)\n[View repositories on GitLab](https://gitlab.com/explore/projects?topic=hacktoberfest)",
    title: "What repositories can I contribute to?",
  },
  {
    name: "shipping",
    content:
